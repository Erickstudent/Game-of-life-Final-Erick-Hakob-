...
function game() {
    ...
    sendData = {
        ...
        EverythingeaterValue: everythingEaterArr.length,
        VirusValue: virusArr.length,
        HunterValue: huntArr.length,
    }
...
setInterval(function(){
    ...
    stats.Everythingeater = everythingEaterArr.length
    stats.Virus = virusArr.length
    stats.Hunter = huntArr.length
